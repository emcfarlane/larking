...
func (x *HttpBody) ProtoReflect() protoreflect.Message {
	return file_google_api_httpbody_proto_msgTypes[0].MessageOf(x)
}

func (m *HttpBody) XXX_Methods() *protoiface.Methods {
	return file_google_api_httpbody_proto_msgTypes[0].Methods()
}

// Deprecated: Use HttpBody.ProtoReflect.Type instead.
