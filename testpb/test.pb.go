...
var file_testpb_test_proto_rawDesc = []byte{
	...
	0xb3, 0x0b, 0x0a, 0x09, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x12, 0x72, 0x0a,
	...
	0x61, 0x74, 0x63, 0x68, 0x3a, 0x01, 0x2a, 0x12, 0x53, 0x0a, 0x0b, 0x56, 0x61, 0x72, 0x69, 0x61,
	...
	0x6f, 0x6d, 0x2f, 0x65, 0x6d, 0x63, 0x66, 0x61, 0x72, 0x6c, 0x61, 0x6e, 0x65, 0x2f, 0x6c, 0x61,
	0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62, 0x3b, 0x74, 0x65, 0x73,
...
var file_testpb_test_proto_depIdxs = []int32{
	...
	7,  // 27: larking.testpb.Messaging.GetShelf:input_type -> larking.testpb.GetShelfRequest
	9,  // 28: larking.testpb.Messaging.GetBook:input_type -> larking.testpb.GetBookRequest
	10, // 29: larking.testpb.Messaging.CreateBook:input_type -> larking.testpb.CreateBookRequest
	11, // 30: larking.testpb.Messaging.UpdateBook:input_type -> larking.testpb.UpdateBookRequest
	4,  // 31: larking.testpb.Files.UploadDownload:input_type -> larking.testpb.UploadFileRequest
	4,  // 32: larking.testpb.Files.LargeUploadDownload:input_type -> larking.testpb.UploadFileRequest
	5,  // 33: larking.testpb.WellKnown.Check:input_type -> larking.testpb.Scalars
	0,  // 34: larking.testpb.Messaging.GetMessageOne:output_type -> larking.testpb.Message
	0,  // 35: larking.testpb.Messaging.GetMessageTwo:output_type -> larking.testpb.Message
	0,  // 36: larking.testpb.Messaging.UpdateMessage:output_type -> larking.testpb.Message
	0,  // 37: larking.testpb.Messaging.UpdateMessageBody:output_type -> larking.testpb.Message
	26, // 38: larking.testpb.Messaging.Action:output_type -> google.protobuf.Empty
	26, // 39: larking.testpb.Messaging.ActionSegment:output_type -> google.protobuf.Empty
	26, // 40: larking.testpb.Messaging.ActionSegments:output_type -> google.protobuf.Empty
	26, // 41: larking.testpb.Messaging.VariableOne:output_type -> google.protobuf.Empty
	26, // 42: larking.testpb.Messaging.VariableTwo:output_type -> google.protobuf.Empty
	6,  // 43: larking.testpb.Messaging.GetShelf:output_type -> larking.testpb.Shelf
	8,  // 44: larking.testpb.Messaging.GetBook:output_type -> larking.testpb.Book
	8,  // 45: larking.testpb.Messaging.CreateBook:output_type -> larking.testpb.Book
	8,  // 46: larking.testpb.Messaging.UpdateBook:output_type -> larking.testpb.Book
	13, // 47: larking.testpb.Files.UploadDownload:output_type -> google.api.HttpBody
	13, // 48: larking.testpb.Files.LargeUploadDownload:output_type -> google.api.HttpBody
	26, // 49: larking.testpb.WellKnown.Check:output_type -> google.protobuf.Empty
