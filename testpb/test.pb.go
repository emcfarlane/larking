...
// 	protoc        v3.11.2
// source: github.com/afking/gateway/testpb/test.proto
...
func (x *Message) Reset() {
	*x = Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_afking_gateway_testpb_test_proto_msgTypes[0]
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_github_com_afking_gateway_testpb_test_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetMessageRequestOne) Reset() {
	*x = GetMessageRequestOne{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_afking_gateway_testpb_test_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetMessageRequestOne) Descriptor() ([]byte, []int) {
	return file_github_com_afking_gateway_testpb_test_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetMessageRequestTwo) Reset() {
	*x = GetMessageRequestTwo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_afking_gateway_testpb_test_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetMessageRequestTwo) Descriptor() ([]byte, []int) {
	return file_github_com_afking_gateway_testpb_test_proto_rawDescGZIP(), []int{2}
}
...
func (x *UpdateMessageRequestOne) Reset() {
	*x = UpdateMessageRequestOne{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_afking_gateway_testpb_test_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateMessageRequestOne) Descriptor() ([]byte, []int) {
	return file_github_com_afking_gateway_testpb_test_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetMessageRequestTwo_SubMessage) Reset() {
	*x = GetMessageRequestTwo_SubMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_afking_gateway_testpb_test_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetMessageRequestTwo_SubMessage) Descriptor() ([]byte, []int) {
	return file_github_com_afking_gateway_testpb_test_proto_rawDescGZIP(), []int{2, 0}
}
...
var File_github_com_afking_gateway_testpb_test_proto protoreflect.FileDescriptor

var file_github_com_afking_gateway_testpb_test_proto_rawDesc = []byte{
	0x0a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x66, 0x6b,
	0x69, 0x6e, 0x67, 0x2f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x74, 0x65, 0x73, 0x74,
	0x70, 0x62, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x67,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62, 0x1a, 0x1c, 0x67,
	...
	0x2f, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62,
	...
	0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x65,
	...
	0x65, 0x4f, 0x6e, 0x65, 0x12, 0x24, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x74,
	0x65, 0x73, 0x74, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4f, 0x6e, 0x65, 0x1a, 0x17, 0x2e, 0x67, 0x61, 0x74,
	0x65, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x54, 0x77, 0x6f, 0x12, 0x24, 0x2e, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x77, 0x6f, 0x1a,
	0x17, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62,
	...
	0x74, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x27, 0x2e, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4f,
	0x6e, 0x65, 0x1a, 0x17, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x65, 0x73,
	...
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62, 0x2e, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x17, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e,
	...
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62, 0x3b, 0x74, 0x65,
	0x73, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_github_com_afking_gateway_testpb_test_proto_rawDescOnce sync.Once
	file_github_com_afking_gateway_testpb_test_proto_rawDescData = file_github_com_afking_gateway_testpb_test_proto_rawDesc
)

func file_github_com_afking_gateway_testpb_test_proto_rawDescGZIP() []byte {
	file_github_com_afking_gateway_testpb_test_proto_rawDescOnce.Do(func() {
		file_github_com_afking_gateway_testpb_test_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_afking_gateway_testpb_test_proto_rawDescData)
	})
	return file_github_com_afking_gateway_testpb_test_proto_rawDescData
}

var file_github_com_afking_gateway_testpb_test_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_github_com_afking_gateway_testpb_test_proto_goTypes = []interface{}{
...
var file_github_com_afking_gateway_testpb_test_proto_depIdxs = []int32{
	4, // 0: gateway.testpb.GetMessageRequestTwo.sub:type_name -> gateway.testpb.GetMessageRequestTwo.SubMessage
	0, // 1: gateway.testpb.UpdateMessageRequestOne.message:type_name -> gateway.testpb.Message
	1, // 2: gateway.testpb.Messaging.GetMessageOne:input_type -> gateway.testpb.GetMessageRequestOne
	2, // 3: gateway.testpb.Messaging.GetMessageTwo:input_type -> gateway.testpb.GetMessageRequestTwo
	3, // 4: gateway.testpb.Messaging.UpdateMessage:input_type -> gateway.testpb.UpdateMessageRequestOne
	0, // 5: gateway.testpb.Messaging.UpdateMessageBody:input_type -> gateway.testpb.Message
	0, // 6: gateway.testpb.Messaging.GetMessageOne:output_type -> gateway.testpb.Message
	0, // 7: gateway.testpb.Messaging.GetMessageTwo:output_type -> gateway.testpb.Message
	0, // 8: gateway.testpb.Messaging.UpdateMessage:output_type -> gateway.testpb.Message
	0, // 9: gateway.testpb.Messaging.UpdateMessageBody:output_type -> gateway.testpb.Message
...
func init() { file_github_com_afking_gateway_testpb_test_proto_init() }
func file_github_com_afking_gateway_testpb_test_proto_init() {
	if File_github_com_afking_gateway_testpb_test_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_github_com_afking_gateway_testpb_test_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_afking_gateway_testpb_test_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_afking_gateway_testpb_test_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_afking_gateway_testpb_test_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_afking_gateway_testpb_test_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_afking_gateway_testpb_test_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_github_com_afking_gateway_testpb_test_proto_goTypes,
		DependencyIndexes: file_github_com_afking_gateway_testpb_test_proto_depIdxs,
		MessageInfos:      file_github_com_afking_gateway_testpb_test_proto_msgTypes,
	}.Build()
	File_github_com_afking_gateway_testpb_test_proto = out.File
	file_github_com_afking_gateway_testpb_test_proto_rawDesc = nil
	file_github_com_afking_gateway_testpb_test_proto_goTypes = nil
	file_github_com_afking_gateway_testpb_test_proto_depIdxs = nil
}
